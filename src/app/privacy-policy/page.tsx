  ...
  return (
    <LegalArticle title="Privacy Policy" effectiveDate="2026-08-30">
      ...
      <p>
        ...
        Switzerland is protected by Switzerland&apos;s Federal Act on Data Protection (FADP) rather
        than the GDPR.) Everywhere else, including the United States, analytics cookies are set from
        your first pageview. Our Cookie Policy describes this in detail.
      </p>
      <p>
